...
const style = {
  ...
  wholeCenter: `relative flex flex-col items-center top-[10rem]`,
  centerContainer: ``,
  ...
  poweredContainer: `flex flex-row justify-center mt-[2rem]`,
  poweredText: `text-[#d3d3d3]`,
  poweredImg: ``,
  answerSection: `text-white text-4xl text-center`,
  textHolder: `flex flex-row justify-center align-center items-center`,
  answer: `select-text`,
  bottomContainer: `flex flex-col justify-center items-center`,
  emotes: `cursor-pointer text-white text-[3.5rem] flex justify-center pt-[0.5rem] pb-[0.6rem] mt-[3rem] mb-[2rem] animate-bounce`,
  submitBtn: `cursor-pointer bg-white w-[7rem] h-[2.4rem] flex justify-center items-center rounded text-black hover:bg-black hover:text-white`,
  btnText: `text-xl`,
};
    ...
    <>
      <div className={style.bgContainer}>
        <div className={style.imgContainer}>
          ...
          <div className={style.wholeCenter}>
